...
class TradeMonitoringAlertActivity : AppCompatActivity() {
    ...
    private val endDisplay = Runnable {
        if (!acknowledged) window.clearFlags(WindowManager.LayoutParams.FLAG_KEEP_SCREEN_ON)
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<Button>(R.id.tradeAlertMonitorButton).setOnClickListener {
            ...
            startActivity(android.content.Intent(this, TradeMonitoringActivity::class.java))
            finish()
        }
        playSelectedSound()
